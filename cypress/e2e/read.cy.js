describe("The user should be able to read the client was created", () => {
  ...
  it("should be confirm the created client", () => {
    cy.contains("Amanda");
    cy.contains("amanda@email.com");
    cy.contains("27/12/1998");
  });
});
